 ...
 *
 * 代码地址（使用的是rabbitmq-java-client）： https://github.com/rabbitmq/rabbitmq-java-client/blob/main/src/main/java/com/rabbitmq/client/impl/VariableLinkedBlockingQueue.java
 *
 * @since 1.5
 * @author Doug Lea
