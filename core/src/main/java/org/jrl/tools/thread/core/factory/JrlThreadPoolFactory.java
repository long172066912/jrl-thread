...
import org.jrl.tools.utils.JrlSpiUtil;
...
public class JrlThreadPoolFactory {
    ...
    private static final DynamicThreadPool DYNAMIC_THREAD_POOL = JrlSpiUtil.getInstanceOrDefault(DynamicThreadPool.class, DynamicThreadPool.DefaultDynamicThreadPool::new);
    private static final MonitorThreadPool MONITOR_THREAD_POOL = JrlSpiUtil.getInstanceOrDefault(MonitorThreadPool.class, MonitorThreadPool.DefaultMonitorThreadPool::new);
    /**
     * 所有线程池的管理
     */
